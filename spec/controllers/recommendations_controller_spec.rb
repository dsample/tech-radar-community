  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved recommendation as @recommendation" do
        ...
        post :create, {:recommendation => {  }}, valid_session
        assigns(:recommendation).should be_a_new(Recommendation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested recommendation" do
        ...
        Recommendation.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
        put :update, {:id => recommendation.to_param, :recommendation => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the recommendation as @recommendation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Recommendation.any_instance.stub(:save).and_return(false)
        put :update, {:id => recommendation.to_param, :recommendation => {  }}, valid_session
        assigns(:recommendation).should eq(recommendation)
      end
