  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved technology as @technology" do
        ...
        post :create, {:technology => { "category" => "invalid value" }}, valid_session
        assigns(:technology).should be_a_new(Technology)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested technology" do
        ...
        Technology.any_instance.should_receive(:update_attributes).with({ "category" => "" })
        put :update, {:id => technology.to_param, :technology => { "category" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the technology as @technology" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Technology.any_instance.stub(:save).and_return(false)
        put :update, {:id => technology.to_param, :technology => { "category" => "invalid value" }}, valid_session
        assigns(:technology).should eq(technology)
      end
